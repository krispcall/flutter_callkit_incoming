...
Future<void> main() async {
  ...
  final configuredApp = AppConfig(
    liveUrl: "https://uat.inboxsure.com/api/v1/graphql/",
    socketUrl: "wss://uat.inboxsure.com/api/v1/graphql",
    appSubscriptionEndpoint: "wss://uat.inboxsure.com/api/v1/graphql/ws",
    imageUrl: "https://uat.inboxsure.com",
    countryLogoUrl: "https://krispcall-prod.sgp1.digitaloceanspaces.com",
    nameConfig: AppConstant.UAT,
