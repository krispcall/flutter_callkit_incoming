...
class EmergencyCallWidgetDialog extends StatelessWidget {
  final Function? onTap;

  const EmergencyCallWidgetDialog({
    Key? key,
    this.onTap,
  }) : super(key: key);
              ...
              children: [
                Container(
                  ...
                  child: RoundedAssetImageHolder(
                    assetUrl: "assets/images/icon_emergency.png",
                    width: Dimens.space64,
                ...
                Container(
                  ...
                  child: Text(
                    Config.checkOverFlow
                        ? Const.OVERFLOW
                        : " ${Utils.getString("contactSupportDesc")}",
                    textAlign: TextAlign.center,
                    overflow: TextOverflow.ellipsis,
                    maxLines: 2,
                    style: Theme.of(context).textTheme.bodyText2!.copyWith(
                  ...
                  child: TextButton(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        Config.checkOverFlow
                            ? Const.OVERFLOW
                            : Utils.getString("contactSupport"),
                        textAlign: TextAlign.center,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: Theme.of(context).textTheme.bodyText2!.copyWith(
