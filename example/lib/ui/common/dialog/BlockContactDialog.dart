...
class BlockContactDialog extends StatelessWidget {
                ...
                Container(
                  ...
                  child: Text(
                    Config.checkOverFlow
                        ? Const.OVERFLOW
                        : isBlocked
                            ? Utils.getString("youWillReceivePhoneCalls")
                            : Utils.getString("youWillNotReceivePhoneCalls"),
                    textAlign: TextAlign.center,
                    overflow: TextOverflow.ellipsis,
                    maxLines: 2,
                    style: Theme.of(context).textTheme.bodyText2!.copyWith(
