...
///Voice mail
class IncomingRecordingView extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _IncomingRecordingViewState();
}

class _IncomingRecordingViewState extends State<IncomingRecordingView> {
              ...
              Config.checkOverFlow
                  ...
                  : widget.conversationEdge!.recentConversationNodes!
                      ...
                      ? (widget.loginWorkspaceProvider!
                          ...
                          : ("${Utils.getString("receivedBy")}${widget.conversationEdge!.recentConversationNodes!.agentInfo!.firstname}"))
                      : "",
