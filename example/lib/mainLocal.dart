...
Future<void> main() async {
  ...
  const baseURL = "4a2e-103-192-76-16.in.ngrok.io";
  // const baseURL = "abintest.in.ngrok.io";
  // const baseURL = "biswashtest.in.ngrok.io";

  // http://krisptest.in.ngrok.io/
  // 'http://abintest.in.ngrok.io/api/v1/graphql/'

  final configuredApp = AppConfig(
    liveUrl: "https://$baseURL/api/v1/graphql/",
    socketUrl: "wss://$baseURL/api/v1/graphql",
    appSubscriptionEndpoint: "wss://$baseURL/api/v1/graphql/ws",
    imageUrl: "http://$baseURL/",
    countryLogoUrl: "https://krispcall-prod.sgp1.digitaloceanspaces.com",
    nameConfig: AppConstant.LOCAL,
